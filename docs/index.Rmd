...
Here are preliminary results to be output for each of the 8 regions: 
...
```{r figTerDepth, fig.cap="Area of Cumulative Ocean Use by Depth Bin for West region. Cumulative use are counted and summarized by depth bin and area.", eval=F}
...
```{r mapTerDepth, fig.cap='Map of cumulative ocean use in West region.', eval=F}
#names(s)
